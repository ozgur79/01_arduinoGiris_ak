...
oldu; sıradaki kutu `OUTPUT` (3. tur). `{ }` ve `;` rotasyona girmez, ak0020'de KAVRAM
içinde kapandı.
...
| `;` | ak0010 | ak0020 (açıldı) | rotasyon dışı | — | ak0020'de KAVRAM'da açıldı, kapandı |
| `Serial` ve noktalı yazım | ak0110 | "fonksiyon" konusu — temel düzeyin ilerisinde, numarası o tur belirlenecek | 0 tur | ak0110: atlandı (yük freni — yeni seri port aracıyla yeni noktalı yazım birlikte geliyor) | rotasyon sırası daha sonra belirlenecek |
